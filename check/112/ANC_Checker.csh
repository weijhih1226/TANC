...
set LOGISTIC_fpath = "/mnt/ancnas2/logistic"
...
cd "$MDV_fpath/advectGrid/mdvMultFilt/HIMA/rwrf/$date/"
set cnt_Y = `ls *00.mdv |wc -l`
if ( $cnt_Y == 0 ) then
    echo "               NO Files!                "
else
...
cd "$MDV_fpath/advectGrid/mdvMask/HIMA.ir10.7/rwrf/$date/"
set cnt_Y = `ls *00.mdv |wc -l`
if ( $cnt_Y == 0 ) then
    echo "               NO Files!                "
else
